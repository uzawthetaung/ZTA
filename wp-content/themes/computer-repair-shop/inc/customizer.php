...
function computer_repair_shop_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section('computer_repair_shop_service_section',array(
		...
		'description'=> __('Note : This section will appear below the slider.','computer-repair-shop'),
		'panel' => 'computer_repair_shop_panel_id',
	));
	...
	$wp_customize->add_setting( 'computer_repair_shop_service_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	   ));
	 $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'computer_repair_shop_service_color', array(
		   'label' => 'Text Color',
		'section' => 'computer_repair_shop_service_section',
	   )));
